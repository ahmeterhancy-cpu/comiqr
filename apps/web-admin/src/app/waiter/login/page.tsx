...
/**
 * Dedicated waiter login — separate from the panel. Staff sign in and land
 * straight on the mobile-first /waiter floor board, never the admin panel.
 */
    ...
    <div className="grid min-h-screen place-items-center bg-slate-900 px-4">
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-2xl">
        <div className="mb-6 flex flex-col items-center gap-3 text-center">
          ...
          <div>
            <h1 className="text-lg font-bold text-ink">{t('loginTitle')}</h1>
            <p className="mt-0.5 text-xs text-muted">{t('loginSubtitle')}</p>
          </div>
        </div>
