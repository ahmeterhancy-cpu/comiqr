...
class HappyHour
{
    /** Active discount percent (0 when disabled or outside the window). */
    public static function percent(?array $settings, ?CarbonInterface $now = null): float
    {
    ...
    public static function active(?array $settings, ?CarbonInterface $now = null): bool
    {
        return self::percent($settings, $now) > 0;
    }
